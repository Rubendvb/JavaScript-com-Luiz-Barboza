class festa {
  ...
  CalculaTotal() {
    var total = 0
    total =
      this.CalculaComidas() + this.CalculaDecoracao() + this.CalculaBebidas()
    return total
  }
}
...
console.log(
  ' Comidas = ' +
    festa150AlcDif.CalculaComidas() +
    ' Decoracao = ' +
    festa150AlcDif.CalculaDecoracao() +
    'Bebidas + ' +
    festa150AlcDif.CalculaBebidas() +
    ' P x pessoas = ' +
    festa150AlcDif.nroPessoas
)
